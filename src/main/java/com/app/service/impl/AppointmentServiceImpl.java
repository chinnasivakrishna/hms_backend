...
public class AppointmentServiceImpl implements AppointmentServiceIntf {
	...
	@Override
	public Long bookAppointmentForPatient(Long doctorId, Long patientId, String stime, String chatDescription) {
		...
		Appointment appointment = new Appointment(time, doctor, patient, chatDescription); // Include chat description
	...
	public Appointment getAppointment(Long appointmentId) {
		...
		return new Appointment(null, null, null, appointment.getChatDescription());
	}
