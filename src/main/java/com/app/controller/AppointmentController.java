...
public class AppointmentController {
	...
	@GetMapping("/bookAppointment/{doctorId}/{patientId}/{time}/{chatDescription}")
	public Long bookAppointmentForPatient(@PathVariable Long doctorId, @PathVariable Long patientId,
			@PathVariable String time, @PathVariable String chatDescription) {

		return appointmentService.bookAppointmentForPatient(doctorId, patientId, time, chatDescription);
	}
