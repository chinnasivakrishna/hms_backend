...
class DaoTest {
	...
	void savePatient() {
		...
		Patient p1 = new Patient("p3", "p3", "p3", "p3@gmail.com", "p3@123", LocalDate.parse("1995-11-01"), Gender.MALE,
				"48765", BloodGroup.A_POSITIVE, "Kalyan", "Mumbai", "MH");
		Patient p2 = new Patient("p4", "p4", "p4", "p4@gmail.com", "p4@123", LocalDate.parse("1995-11-01"),
				Gender.FEMALE, "48765", BloodGroup.B_POSITIVE, "Bhosari", "Pune", "MH");
	...
	void TestCreateTableTimeSlots() {
		DoctorTimeTable timeTable = new DoctorTimeTable(LocalDate.parse("2021-09-21"), LocalDate.parse("2021-09-30"),
				LocalTime.parse("07:00:00"), LocalTime.parse("15:00:00"), 30, LocalTime.parse("12:00:00"),
				new ArrayList<>(Arrays.asList("Monday")));
		// timeTable.openSlots();
	 ...
	 * 
	 * // DoctorTimeTable tt = new DoctorTimeTable(LocalTime.parse("07:00:00"),
	 * LocalTime.parse("15:00:00"), 30,
	 * // LocalTime.parse("13:00:00"), 30);
	 * AppointmentSlot apt = new AppointmentSlot(LocalDate.parse("2021-09-23"),
	 * LocalDate.parse("2021-09-30"), LocalTime.parse("08:00:00"),
	 * LocalTime.parse("13:00:00"), 20, LocalTime.parse("11:00:00"), 30, new
	 * ArrayList<>(Arrays.asList("Saturday", "Sunday")));
	 * List<LocalDateTime> list = doctorService.createAvailableSlotsDetails(4l,
	 * apt);
	 * System.out.println(list);
	 * //System.out.println(g.getAvailableSlots());
	 * assertTrue(true);
	...
	void bookAppointment() {
		// LocalDateTime t1 = LocalDateTime.of(LocalDate.parse("2021-09-30"),
	...
	@Test
	void saveDonor() {
		List<BloodDonor> bd = Arrays.asList(
				new BloodDonor("bd2", "bd2@gmail.com", "9809789898", BloodGroup.B_POSITIVE, "Pune", "MH"),
